...
import { 
  ...
  ChevronDown, LogOut, Plus, AlertTriangle, Clock, CheckCircle
} from 'lucide-react';
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            {dashboardData.recent_activities.map((activity, index) => {
              const IconComponent = { ShoppingCart, AlertTriangle, MapPin, CheckCircle }[activity.icon];
              return (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            {dashboardData.alerts.map((alert, index) => {
              const IconComponent = { AlertTriangle, Package, Coins, Users }[alert.icon];
              return (
            ...
            <div className={`flex items-center ${sidebarOpen ? 'space-x-3' : 'justify-center'}`}>
              ...
              {sidebarOpen && (
                <div>
                  ...
                  <p className="text-xs text-gray-500">admin@lanfiatech.com</p>
                </div>
              )}
            </div>
          </div>
